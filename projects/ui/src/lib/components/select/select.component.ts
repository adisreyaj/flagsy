...
@Component({
  ...
  template: `
    <button
      class="py-2 px-4 pr-2 flex justify-between items-center w-full border border-gray-200 rounded-lg focus:ring-1 focus:border-primary-500 focus:ring-primary-500 disabled:opacity-50 disabled:pointer-events-none transition-all duration-300"
